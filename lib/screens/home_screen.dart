                                ...
                                Padding(
                                    ...
                                    child:   ButtonTheme(
                                      ...
                                      child: MaterialButton(
                                        color: (state.locations??[])[index]["id"] == _selected_location? Colors.purple: Colors.purple.withOpacity(0.1),
                                        shape: OutlineInputBorder(
                                            borderRadius: BorderRadius.circular(18),
                                          borderSide: BorderSide(width: 1, color: Colors.purple)
                                        ),
                                        onPressed: () {
                                          _handleSelectLocation((state.locations??[])[index]["id"]);
                                        },
                                        child: Text((state.locations??[])[index]["name"], style: TextStyle(fontSize: 12),),
                                      ),
                                    )
                                )
                            )
